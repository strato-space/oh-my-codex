...
function buildAutopilotPromptActivationNote(
  ...
  return [
    ...
    "The ralplan phase is not complete until Planner output has been reviewed sequentially by Architect, then Scholastic, then Critic; do not hand off to Ultragoal or implementation until the ralplan state/artifact records ralplan_architect_review, ralplan_scholastic_review, and ralplan_critic_review with approval or an explicit blocker.",
